...
import TransformImage from "@/assets/images/transformImage.png";
  ...
  return (
    <section>
      <div className={`${styles.transformationContainer} container`}>
        <h1 className={styles.transformationTextHeader}>We help your <span> business growth </span> via digital transformation</h1>
